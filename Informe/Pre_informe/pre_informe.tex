...
%$.$ No me acuerdo qué era lo que hacíamos inicialmente que daba unos coeficientes enormes. Eso hay que ponerlo. Agregado arriba.
...
\end{center}
\end{table}
%$.$ Seba: Acá falta decir qué se entiende por "esfuerzo del controlador". Era el dw máximo, no?. Por otro lado, el Tas era el valor simulado, no? Habría que aclararlo. Además, me parece que habría que mostrar la pista usada. Tania: Lo del esfuerzo del controlador esta explicado antes de la tabla. (estaba antes, ahora lo modifique, porque me parece que no estaba claro.)
