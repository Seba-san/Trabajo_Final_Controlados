...
\end{tabular}
\caption{Mediciones de distintos controladores sobre la pista de la facultad. Referencias: $E_c$ esfuerzo del controlador, $T_{as}$ tiempo de asentamiento, $N^o$ v: Numero de vueltas, $P_l$ pierde linea, $TV_{med}$ promedio de tiempo por vuelta}
