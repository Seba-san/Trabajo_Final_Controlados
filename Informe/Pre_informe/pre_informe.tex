...
\begin{equation}
\vert \omega \vert	=\frac{ \vert r(\omega _R - \omega _L) \vert }{L}
\end{equation}
...
\begin{equation}
\dot{\beta}=\vert \omega \vert	=\frac{ \vert r(\omega _R - \omega _L) \vert }{L}
\end{equation}
...
En este caso la velocidad del punto  C (punto medio entre las dos ruedas del robot) tiene una componente tangencial, v, y una componente de giro, $\omega$, dadas por: REVISAR ESTAS ECUACIONES; ESTAN MAL!
...
\begin{equation}
\omega =\frac{r(\omega _R - \omega _L) }{2}= \frac{  r \Delta \omega} {R}
\end{equation}
