...
for k=1:N %Ojo con el tope que pone el nano
    ...
    dato=str2double(fscanf(s));%Actualmente el nano estï¿½ enviando la vel en rpm y el tiempo en us.
    wA=[wA dato];
...
%Nota: no funcionó :( . Para 2 polos 1 cero parece que da exactamente el
%mismo sistema que la versión no desplazada.
